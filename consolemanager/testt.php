...
{echo'
  <nav id="nav">
   ...
   <ul class="twitter" role="navigation">
	...
	<li><a href="featured.php"><i class="fa fa-check"></i></a></li>
	
	<li><a href="reporting.php"><i class="fa fa-book"></i></a></li>
	...
	echo'
	  ...
	  <li><a href="help.php"><i class="fa fa-plane"></i></a></li>';
	echo'<li><a href="log out.php"><i class="fa fa-arrow-up"></i></a></li>';

   echo'<li><button>Linksxup console</button></li>
  </ul>

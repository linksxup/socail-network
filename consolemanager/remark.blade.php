...
if(isset($user)){
  ...
  <form action="remarks.php?un=<?php $to=$_GET['un'];
 echo"$to";?>" method="post">
 @csrf
...
$row=mysqli_fetch_array($result);
    ...
    echo"<li><b>Send message Remark to Un@"; 
...
echo"<textarea id='textstatus' name='textstatus' placeholder ='Write message'required= 'required' ></textarea>
</fieldset>
	</form>";

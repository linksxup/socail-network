   ...
   <br><br>'; echo'</br> <li>';
    ...
    echo'<li>';
       echo' <ul>';
		...
		echo' <li><a href="'; echo'delete.php?uniqueid='; echo$row["uniqueid"]; echo'&status=linkupdate"><i class="fa fa-trash-o"></i></a></li>';
...
require_once 'database.php';
		...
		$query4 = "SELECT * FROM remarks";
		$query5 = "SELECT * FROM replies";
		
		$result3=mysqli_query($link, $query3);
		$result22= mysqli_num_rows($result3);
		$result44=mysqli_query($link, $query4);
		$result66=mysqli_query($link, $query5);
		
$result = mysqli_query($link, $query);
$result1=mysqli_query($link, $query1);		

$result2= mysqli_num_rows($result1);
$result55= mysqli_num_rows($result44);
$result77= mysqli_num_rows($result66);
	if(mysqli_num_rows($result) > 0){
...
echo'<fieldset>';
	echo'<br>Total number of signed up users:&nbsp'; print_r($result22);
	echo'<br>Total number of posts:&nbsp'; print_r($result2);
	echo'<br>Total number of remarks:&nbsp'; print_r($result55);
		echo'<br>Total number of replies:&nbsp'; print_r($result77);
	echo'</fieldset>';

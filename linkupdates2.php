...
require_once 'database.php';
		...
		$query = "SELECT * FROM linkupdates WHERE username='$key'  ORDER  BY TIME DESC LIMIT $limit OFFSET $start;";
		
		$query11 = "SELECT * FROM linkupdates WHERE username='$key'  ORDER  BY TIME DESC";
...
//echo"$no";
		...
		//echo substr("$row[caption]","0", "200"); echo'... ';	

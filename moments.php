...
//insert into moment2
$stmt=mysqli_query($link, "INSERT INTO moment2 (username, url, caption, file_type, uniqueid, gender, viewers) 
VALUES ('$user', '$filedestination', '$cap', 
'$fileactualext1', '$uniqueid', '$row[gender]', '')");
...
//require'database.php';
					 //$stm = mysqli_query($link, "INSERT INTO notifications (username, status, url, achieve, format, message, uniqueid) VALUES ('$user', 'regular', 'story.php?pid=$uniqueid', 'unread', 'linkupdate/image', 'shared to moments', '')");	
...
//insert into moment2
$stmt=mysqli_query($link, "INSERT INTO moment2 (username, url, caption, file_type, uniqueid, gender) 
VALUES ('$user', '$filedestination', '$cap', 
'$filee', '$uniqueid', '$row[gender]')");
...
<font color="red"> The maximum number of images to share is 6. </font></h4>

...
<head>
  ...
  <meta charset="UTF-8">
  <title>Help - Linksxup</title>
  
  
  <meta name="description" content="Linksxup - terms of service"/>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.7.0/js/bootstrap.min.js"></script>
 ...
 <ul class="twitter" role="navigation">
	...
	&nbsp <li><span class="login100-form-avatar">
	<img src="icon.png" alt="AVATAR">
	</span></li> 


		<li><a href="testt.php"><i class="fa fa-home"></i></a> 
						    </li>
  </ul>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	...
                        	<form role="form" action="help.php" method="post" class="registration-form">
...
require'database.php';
 $stm=mysqli_query($link, "INSERT INTO help (name, email, message) VALUES ('$name', '$email', '$message')");


if($stm == true)
{echo'<h3>Contact us:</h3>
<div class="postWraper"><font color="#57b846">Your message has been submitted successfully...</font>         		</div> </div>
		                        	
		                            </div>
		                            <div class="form-bottom">
				                    	<div class="form-group">
				                    		<label class="sr-only" for="form-first-name">Name</label>
				                        	<input type="text" name="name" placeholder="Name" class="form-first-name form-control" id="name" required="required">
				                        </div>
				                        <div class="form-group">
				                        	<label class="sr-only" for="form-last-name">E-mail</label>
				                        	<input type="email" name="email" placeholder="email" class="form-last-name form-control" id="email" required="required">
				                        </div>
										
										
										
										 <div class="form-group">
				                        	<label class="sr-only" for="form-last-name">message</label>
	 ...
	 <li><h6>© 2020 Linksxup.</h6></li></ul> 
			...
			echo'<h3>Contact us:</h3>
<div class="postWraper">For any queries or assistance you may fill the form below or mail us at <a href="mailto: linksxup@gmail.com">linksxup@gmail.com</a></br>
		               </div>
		                            <div class="form-bottom">
				                    	<div class="form-group">
				                    		<label class="sr-only" for="form-first-name">Name</label>

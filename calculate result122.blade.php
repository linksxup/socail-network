...
<form action ='calculate result12.php' method='POST'>
@csrf
<br>Course code.</br>
...
<select name="grade3" size="1" single="single"> 
 <option value="A">A</option>   <option value="B">B</option>   <option value="C">C</option>   <option value="D">D</option>   <option value="E">E</option> <option value="F">F</option></select></br>

...
?>
 ...
 <fieldset>
			...
			<form role="form" action="linkupdate audio.php" method="POST" enctype="multipart/form-data">
					@csrf			
				<div class="box">
					<input type="file" name="file-1[]"  id="file-1" class="inputfile inputfile-1" data-multiple-caption="{count} files selected"   accept="audio/*" required="required"/>
					<label for="file-1"> <span>Linkup audio&nbsp<i class="fa fa-plus"></i></span></label>
				</div>
				<br>
				<div class="text">

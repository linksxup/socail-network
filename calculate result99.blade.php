...
<form action ='calculate result9.php' method='POST'>
@csrf
<br>Course code.</br>
 <input type='text'    placeholder='Course name' name='username' auto complete='on'>

<br>Course load</br>
 <input type='number'    placeholder='Credit load' name='credit'>
...
<br>Course load</br>
 <input type='number'    placeholder='Credit load' name='credit5'>
...
<br>Course load</br>
 <input type='number'    placeholder='Credit load' name='credit6'>
...
<br>Course load</br>
 <input type='number'    placeholder='Credit load' name='credit7'>
...
<br>Course load</br>
 <input type='number'    placeholder='Credit load' name='credit8'>

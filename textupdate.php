...
<style type="text/css">
 ...
 <fieldset>
			...
			<form role="form" action="textupdate2.php" method="GET" enctype="application/x-www-form-urlencoded">
...
if(isset($_GET["content"])){
	...
	echo'<textarea placeholder="'; echo"$_GET[content]"; echo'" name="content" required="required">';
											echo"$_GET[content]"; 

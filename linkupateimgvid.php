...
$stmt=mysqli_query($link, "INSERT INTO linkupdates (username, url, caption, file_type, uniqueid, firstname, lastname, profilepic,verification, gender) VALUES ('$user', '$filedestination', '$cap', '$fileactualext1', '$uniqueid', '$row[firstname]', '$row[lastname]', '$row[profilepic]','$row[verification]', '$row[gender]')");	

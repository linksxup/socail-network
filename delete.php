...
<head>
 ...
 <link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css'>
      ...
      <link rel="stylesheet" href="css/style.css">
           ...
           <script  src="https://www.googletagmanager.com/gtag/js?id=UA-117749332-1"></script>
<script>
...
echo'<ul class="twit" role="navigation">';
	...
	<li><font color="red">Delete confirmation!</font></li>
...
$c=mysqli_fetch_array($a);	
    ...
    echo'<li><i class="fa fa-close"></i></li>';
...
$c=mysqli_fetch_array($a);	
 ...
 echo'<h4 align= "center">Do you actually want to delete?</h4>
    ...
    echo"<li>"; echo'<i class="fa fa-close"></i></li>';
...
echo"$uniqueid"; echo'&status='; echo"$status"; 
   ...
   echo'&confirmation=proceed">Delete</a>
   </button></li> 

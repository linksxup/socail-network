...
echo'
<title>'; echo"$un"; echo'&nbsp linkupdates</title>';?>		
...
<script>
  ...
  <nav id="nav">
   ...
   <li><a href='mylinkups.php'<i class="fa fa-arrow-left"></i></a></li>
    
	
   <li><button><?php echo"$un";   ?>&nbsp linkupdate Xup page</button></li>
  </ul>
...
/////////////////
 ...
 //echo'<div class="link_'; print_r($ui); echo'">www.linksxup.com/remarks.php?pid='; echo$row['uniqueid']; echo'</div>';
   ...
   echo"<input type='hidden' id='key' value='$un'>
   </ul></fieldset>";
  
 
			}	
			
			}else{echo"<fieldset>This user hasn't made any linkupdates yet...</fieldset>";}

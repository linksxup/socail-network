...
$row=mysqli_fetch_array($bio);	
				...
				echo'<p><font color="#57b846"> <p>Former password</font></p>
				                        	
				                        	<textarea placeholder="'; echo"Enter former password"; echo'" name="fpassword" required="required">';
				...
				echo'<p><font color="#57b846"> <p>New password</font></p>
				                        	
				                        	<input type="password" placeholder="'; echo"Enter new password"; echo'" name="npassword" required="required"/>';

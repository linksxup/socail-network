...
<form action ='calculate result20.php' method='POST'>
@csrf
<br>Course code.</br>
...
<br>Course load</br>
 <input type='number'    placeholder='Credit load' name='credit16' required='required'>

Grade
<select name="grade16" size="1" single="single"> 
 <option value="A">A</option>   <option value="B">B</option>   <option value="C">C</option>   <option value="D">D</option>   <option value="E">E</option> <option value="F">F</option></select></select>
...
<br>Course load</br>
 <input type='number'    placeholder='Credit load' name='credit17' required='required'>

Grade
<select name="grade17" size="1" single="single"> 
 <option value="A">A</option>   <option value="B">B</option>   <option value="C">C</option>   <option value="D">D</option>   <option value="E">E</option> <option value="F">F</option></select></select>
...
<br>Course load</br>
 <input type='number'    placeholder='Credit load' name='credit18' required='required'>

Grade
<select name="grade18" size="1" single="single"> 
 <option value="A">A</option>   <option value="B">B</option>   <option value="C">C</option>   <option value="D">D</option>   <option value="E">E</option> <option value="F">F</option></select></select>
...
<br>Course load</br>
 <input type='number'    placeholder='Credit load' name='credit19' required='required'>

Grade
<select name="grade19" size="1" single="single"> 
 <option value="A">A</option>   <option value="B">B</option>   <option value="C">C</option>   <option value="D">D</option>   <option value="E">E</option> <option value="F">F</option></select></select>

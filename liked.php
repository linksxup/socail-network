...
$row = mysqli_fetch_array($result);
	   ...
	   $u=unserialize($row['likes']);
	  print_r(count($u)); echo"&nbsp like(s)";
   echo"</button>
   </form>";
...
/////////////////
 ...
 //if(preg_match('/[^a-z\-0-9]/i',$username)){echo"it match";}else{echo"No match";}
   ...
   //echo'<li> <i class="fa fa-share" id="';print_r($ui); echo'"></i>
   ...
   // <li>
       // <ul>
      //     <b><li class="'; print_r($ui); echo'">Copy link</li></b>
      //  </ul>
    //</li>
	//</ul>
	//</li>';
 ...
 <li><b>'; echo'&nbsp Likes &nbsp<i class="fa fa-arrow-circle-o-down"></i></b></li>
</ul>
<hr></fieldset>';
	...
	$row = mysqli_fetch_array($result1);
		...
		if(empty($row['likes'])){echo"<fieldset>No user has currently liked your linkupdate</fieldset>";}

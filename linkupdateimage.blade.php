...
?>
 ...
 <fieldset>
			...
			<form role="form" action="linkupdate image.php" method="POST" enctype="multipart/form-data">
						@csrf		
				<div class="box">
					<input type="file" name="file-1[]"  id="file-1" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" multiple  accept="image/*" required="required"/>

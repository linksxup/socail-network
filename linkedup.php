...
$('.b').css('color','#fff');
    ...
    $uname=$_GET['un'];
   echo"<li><a href='info.php?un=$uname'<i class='fa fa-arrow-left'></i></a></li>";
    ?>
...
$row = mysqli_fetch_array($result);
	  ...
	  print_r(count($u)); echo"&nbsp linkedup";
   echo"</button>
   </form>";
		...
		<div class="container">
			...
			<div class="form-group">
				<div class="input-group">
					...
					<input type="text" name="search_text" id="search_text" placeholder="Search linkups by username" class="form-control" />
				</div>
			</div>
			<br>
			<div id="result"></div>
...
$(document).ready(function(){
	...
	{
		$.ajax({';
			echo'url:"linkedup1.php?un='; print_r($_GET["un"]); echo'",';
			echo'method:"get",
			data:{query:query},

...
<script>
  ...
  <nav>
 <form action='moments.php' method='post'>
   <ul class="twit" role="navigation">
   
    <li><i class="fa fa-arrow-left"></i></li>
   <li><button>Linkupdate moments</button></li>
...
?>
 ...
 <fieldset>
			...
			<form role="form" action="moments.php" method="POST" enctype="multipart/form-data">
				...
				<div class="box">
					...
					<input type="file" name="file-1[]"  id="file-1" class="inputfile inputfile-1" data-multiple-caption="{count} files selected" required="required"/>
					<label for="file-1"> <span>Linkup image&nbsp<i class="fa fa-plus"></i></span></label>
				</div>
				<br>
				<div class="text">
